  ...
  it('Validate Items in Order #1 for Customer #2', function (done) {
    app
      ...
      .end(function(err, res) {
        ...
        res.body.should.be.instanceof(Array).and.have.lengthOf(3);
        res.body[0].should.have.property('desc').and.be.equal("Table");
        res.body[0].should.have.property('orderId').and.be.equal(2);
        res.body[1].should.have.property('desc').and.be.equal("Chairs");
        res.body[1].should.have.property('orderId').and.be.equal(2);
        res.body[2].should.have.property('desc').and.be.equal("Dishes");
        res.body[2].should.have.property('orderId').and.be.equal(2);
        done();
      });
  });
